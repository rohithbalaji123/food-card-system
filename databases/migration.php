<?php
    ...
    $tables = array(
        ...
        "bills"     =>  array(
                        ...
                        "created_at"    =>  "DATETIME DEFAULT CURRENT_TIMESTAMP",
                        "updated_at"    =>  "DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP",
                        ""              =>  "FOREIGN KEY (customer_id) REFERENCES customers(id) ON DELETE CASCADE, FOREIGN KEY (vendor_id) REFERENCES vendors(id) ON DELETE CASCADE",
                    ),
        ...
        "bill_details"=> array(
                        ...
                        "created_at"    =>  "DATETIME DEFAULT CURRENT_TIMESTAMP",
                        "updated_at"    =>  "DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP",
                        ""              =>  "FOREIGN KEY (item_id) REFERENCES items(id) ON DELETE CASCADE, FOREIGN KEY (bill_id) REFERENCES bills(id) ON DELETE CASCADE",
                    ),
    );
